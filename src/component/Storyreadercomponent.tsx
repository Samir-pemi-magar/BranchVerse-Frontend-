            ...
            <div className="flex flex-wrap gap-2 sm:gap-4 text-sm sm:text-base">
              ...
              {isAuthor && (
                <button
                  ...
                  className="flex gap-2 items-center border-2 px-3 sm:px-4 py-1 border-[#00B8AE] text-[#00B8AE] rounded-sm hover:bg-[#00B8AE] hover:text-white font-semibold transition"
                >
                  <FaPlus />
